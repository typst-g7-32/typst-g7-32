...
- Все аргументы передаются в виде именованных параметров, что обеспечивает гибкость конфигурации и позволяет изменять оформление документа без изменения структуры исходного файла.
